    ...
    >
      ...
      >
        <div className="bg-transparent rounded-3xl p-4 md:p-8 lg:p-12 h-full border-2 shadow-2xl shadow-amber-100">
          <div className="text-5xl md:text-6xl lg:text-8xl mb-4 md:mb-6">
            👋
          </div>
          <h2
            className={`text-3xl md:text-4xl lg:text-6xl font-bold text-white mb-3 md:mb-4  bg-clip-text`}
          >
            Welcome
          </h2>
          {/* <GithubRepos username="June8Yildirim" githubToken={token} /> */}
